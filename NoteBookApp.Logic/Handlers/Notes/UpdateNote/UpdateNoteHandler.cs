...
namespace NoteBookApp.Logic.Handlers.Notes
{
    public class UpdateNoteHandler : HandlerBase<UpdateNoteCommand>
    {
        ...
        public UpdateNoteHandler(ISession session, SecurityInfo securityInfo, IMapper mapper, IDateTimeProvider dateTimeProvider) : base(session, securityInfo, mapper, dateTimeProvider)
        {
        }
