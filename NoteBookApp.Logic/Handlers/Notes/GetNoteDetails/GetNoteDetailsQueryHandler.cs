...
namespace NoteBookApp.Logic.Handlers.Notes
{
    public class GetNoteDetailsQueryHandler : QueryHandlerBase<GetNoteDetailsQuery,NoteDto>
    {
        ...
        public GetNoteDetailsQueryHandler(ISession session, SecurityInfo securityInfo, IMapper mapper, IDateTimeProvider dateTimeProvider) : base(session, securityInfo, mapper, dateTimeProvider)
        {
        }
