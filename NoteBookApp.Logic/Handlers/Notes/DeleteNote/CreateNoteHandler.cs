...
namespace NoteBookApp.Logic.Handlers.Notes
{
    public class DeleteNoteHandler : HandlerBase<DeleteNoteCommand>
    {
        ...
        public DeleteNoteHandler(ISession session, SecurityInfo securityInfo, IMapper mapper, IDateTimeProvider dateTimeProvider) : base(session, securityInfo, mapper, dateTimeProvider)
        {
        }
