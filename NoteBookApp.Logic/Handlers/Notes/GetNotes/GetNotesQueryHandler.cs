...
namespace NoteBookApp.Logic.Handlers.Notes
{
    public class GetNotesQueryHandler : QueryHandlerBase<GetNotesQuery, PagedResult<NoteDto>>
    {
        ...
        public GetNotesQueryHandler(ISession session, SecurityInfo securityInfo, IMapper mapper, IDateTimeProvider dateTimeProvider) : base(session, securityInfo, mapper, dateTimeProvider)
        {
        }
